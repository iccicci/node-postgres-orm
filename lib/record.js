...
Record.prototype.del = function(done, doneOk) {
	...
	if(typeof(done) !== "function")
		throw new Error("Pgo.record.del: done must be a function");
...
Record.prototype.wasDeleted = function(done, err, msg) {
	...
	process.nextTick(done.bind(null, { pgo: {
		code:    err,
		doing:   errors[err],
		message: msg
	}}));
